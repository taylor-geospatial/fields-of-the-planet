...
- **`all_polygon_metrics_long.csv`** — tidy long format, one row per (source_file, model, country).
  ...
  `source_file, model, imagery, backbone, license_split, protocol, country, n_patches, pq, sq, rq,
  f1_5_95, poly_count_delta_mean, poly_count_delta_p50, bnd_err_mean_m, bnd_err_p95_m`.
